                        ...
                        <div class="row row-in">
                            <div class="col-lg-4 col-sm-12 row-in-br">
                                <ul class="col-in">
                                    ...
                                    <li class="col-last">
                                        <h3 class="counter text-right m-t-15">@isset($data['total_categories']){{ $data['total_categories'] }}@endisset</h3></li>
                                    <li class="col-middle">
                            ...
                            <div class="col-lg-4 col-sm-12 row-in-br  b-r-none">
                                <ul class="col-in">
                                    ...
                                    <li class="col-last">
                                        <h3 class="counter text-right m-t-15">@isset($data['total_posts']){{ $data['total_posts'] }}@endisset</h3></li>
                                    <li class="col-middle">
                                        <h4>Total News</h4>
                                        <div class="progress">
                            ...
                            <div class="col-lg-4 col-sm-12  b-0">
                                <ul class="col-in">
                                    ...
                                    <li class="col-last">
                                        <h3 class="counter text-right m-t-15">@isset($data['total_events']){{ $data['total_events'] }}@endisset</h3></li>
                                    <li class="col-middle">
                                        <h4>Total Events</h4>
                                        <div class="progress">
