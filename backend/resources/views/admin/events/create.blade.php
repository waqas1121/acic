        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="white-box">
                    ...
                    {{ Form::open([ 'route' => 'events.store','class'=>'form-horizontal generalForm','enctype'=>'multipart/form-data']) }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <input type="date" name="from_date"
                                   ...
                                   required autocomplete="from_date" autofocus id="from_date"
                        ...
                        <div class="col-sm-3">
                            <input type="date" name="to_date"
                                   ...
                                   required autocomplete="to_date" autofocus id="to_date"
                                   placeholder="Enter Date">
                            @error('to_date')
                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
