    ...
    <div class="container-fluid">
        <div class="row bg-title">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Add Obituaries</li>
                </ol>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="white-box">
                    <h3 class="box-title m-b-0">Add Obituaries</h3>
                    {{ Form::open([ 'route' => 'obituaries.store','class'=>'form-horizontal generalForm','enctype'=>'multipart/form-data']) }}
