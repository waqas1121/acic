        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="white-box">
                    ...
                    <p class="text-muted m-b-30">News List</p>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="myModalLabel">News Detail</h4></div>
...
@section('scripts')
    <script type="text/javascript">
        ...
        function del_selected() {
            swal({
                title: "Are you sure?",
                text: "These News will be deleted permanently",
                type: "warning",
                showCancelButton: true,
                closeOnConfirm: false,
                ...
                $("#uform").submit();
                setTimeout(function () {
                    swal("News deleted successfully. Thanks");
                }, 4000);
            });
        }
    </script>
    ...
    <script>
        ...
        function viewInfo(id) {
            ...
            $.post("{{ route('admin.getPost') }}", {_token: CSRF_TOKEN, id: id}).done(function (response) {
